...
<template>
    <header class="p-4 dark:bg-gray-800 dark:text-gray-100">
        <div class="container flex justify-between h-16 mx-auto">
            <div class="flex">
                <router-link to="/" rel="noopener noreferrer" aria-label="Back to homepage" class="flex items-center p-2">
                ...
                <ul class="items-stretch hidden space-x-3 lg:flex">
                    <li class="flex">
                        <router-link :to="{ name: 'home' }"
                            class="flex items-center px-4 -mb-1 border-b-2 dark:border-transparent">Home</router-link>
                    </li>
                    <li class="flex">
                        <router-link :to="{ name: 'blog' }"
                            class="flex items-center px-4 -mb-1 border-b-2 dark:border-transparent">Blog</router-link>
                    </li>
                    <li class="flex">
                        <router-link to="/about"
                            class="flex items-center px-4 -mb-1 border-b-2 dark:border-transparent">About</router-link>
                    </li>
                    <li class="flex">
                        <router-link to="/contact"
                            class="flex items-center px-4 -mb-1 border-b-2 dark:border-transparent">Contact</router-link>
                    </li>
                </ul>
            </div>
            <div class="items-center flex-shrink-0 hidden lg:flex">
                <button
                    class="px-8 py-3 bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 border border-blue-700 rounded">Log
                    in</button>
            </div>
